    ...
    <div className="min-h-screen bg-[#050505] text-white p-6 flex flex-col items-center font-sans">
      <div className="w-full max-w-md flex items-center justify-between mb-8">
        ...
        <div className="flex flex-col items-end">
          <span className="text-[10px] font-black uppercase tracking-widest text-blue-500 italic">Delivery Portal</span>
          <span className="text-xs font-bold text-slate-500">{SITE_CONFIG.propertyName}</span>
        </div>
      </div>
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="space-y-3">
          <div className="bg-[#111] border border-white/5 p-5 rounded-3xl flex items-start gap-4 text-left">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm leading-relaxed">{SITE_CONFIG.deliveryInstructions}</p>
            </div>
          </div>
          ...
          <div className="bg-[#111] border border-white/5 p-5 rounded-3xl flex items-start gap-4 text-left">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm italic">
                M-F: {SITE_CONFIG.hours.weekdays.open}am - {SITE_CONFIG.hours.weekdays.close - 12}pm | 
                Sat: {SITE_CONFIG.hours.saturday.open}am - {SITE_CONFIG.hours.saturday.close - 12}pm
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-4">
          <a href={`tel:${SITE_CONFIG.officePhone}`} className="bg-blue-600 flex items-center justify-center gap-3 p-6 rounded-[2rem] text-white shadow-[0_15px_30px_-10px_rgba(37,99,235,0.4)] active:scale-95 transition-all">
      ...
      <footer className="mt-auto py-10 opacity-30">
        <span className="text-[9px] font-black uppercase tracking-[0.4em]">{SITE_CONFIG.footerText}</span>
      </footer>
    </div>
  );
}
